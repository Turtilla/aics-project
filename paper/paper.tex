...
During the training, we tried different hyperparameters for loading the data. Changing the method for filtering captions that contain relations didn't provide big differences in first tests. Therefore, we utilized solely the simpler POS-based approach for all experiments.
